 ...
 * All appearance attribute definitions are centralized here for consistency across the app.
 */
...
const DEFAULT_PORTRAIT_PROMPT = 'portrait, looking at view, neutral background, upper body, grinning, happy,';
const DEFAULT_PORTRAIT_NEGATIVE = 'photo frame, frame, picture, zoomed in';

/** Default full body preview prompt */
const DEFAULT_FULLBODY_PROMPT = 'full body, standing, neutral pose, simple background, studio lighting';
const DEFAULT_FULLBODY_NEGATIVE = 'cropped, partial body, close-up, portrait';
...
class PromptBuilderService {
    ...
    getRegionsForShot(shotType: ShotType): PromptRegion[] {
        switch (shotType) {
            case 'portrait':
                return [PromptRegion.HEAD];
            case 'upper_body':
                return [PromptRegion.HEAD, PromptRegion.UPPER_BODY];
            case 'full_body':
                return [PromptRegion.HEAD, PromptRegion.UPPER_BODY, PromptRegion.LOWER_BODY, PromptRegion.FULL_BODY];
            default:
                return [PromptRegion.HEAD, PromptRegion.UPPER_BODY, PromptRegion.LOWER_BODY, PromptRegion.FULL_BODY];
        }
    }
    ...
    buildFromAppearance(
        ...
        const attributeFields: (keyof typeof APPEARANCE_ATTRIBUTES)[] = [
            // Core attributes
...
export {APPEARANCE_ATTRIBUTES, DEFAULT_QUALITY_TAGS, DEFAULT_NEGATIVE_TAGS};
